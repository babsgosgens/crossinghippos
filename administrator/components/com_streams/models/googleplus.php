...
// google libraries
require_once( JPATH_SITE.'/libraries/streams/googleplus/Google_Client.php' );
require_once( JPATH_SITE.'/libraries/streams/googleplus/contrib/Google_PlusService.php' );
