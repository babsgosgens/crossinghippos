 ...
 */
class Jvsocial_publishModelchannels extends JModelList {
    ...
    protected function populateState($ordering = null, $direction = null) {
        ...
        $post = $app->getUserStateFromRequest($this->context . '.filter.post', 'filter_post', '', 'string');
    ...
    protected function getListQuery() {
        ...
        // Filter by post
        $post = $this->getState('filter.post');
        if ($post) {
            $query->where('a.post = '.$db->quote($post));
        }
