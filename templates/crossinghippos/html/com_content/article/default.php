...
<header class="leader--half lt-prime lt-prime--clear lt-gutters">
	...
	var disqus_shortname = "crossinghippos",disqus_title = "<?php echo $this->escape($this->item->title); ?>",disqus_identifier = "<?php echo $this->escape($this->item->slug); ?>",disqus_url = "<?php echo $url; ?>";
